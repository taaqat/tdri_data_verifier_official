...
charts = {
    ...
    "chart_brand_subcategory": ["step1", "step2", "step5", "step6"],
    "chart_brand_further_subcategory": ["step1", "step2", "step5", "step6"],
...
Config = {
    ...
    "chart_brand_further_subcategory": [
        "id",
        "category",
        "subcategory",
        "further_subcategory",
